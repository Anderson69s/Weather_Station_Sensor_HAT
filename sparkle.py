...
while True :
    ...
    for i in range (0,1) :
        sense.show_message("Bienvenue", text_colour=blue, back_colour=white, scroll_speed=0.05)
        sense.show_message("@", text_colour=green, back_colour=none, scroll_speed=0.05)
        sense.show_message("YouFactory", text_colour=white, back_colour=red, scroll_speed=0.05)
    ...
    params = urllib.urlencode({'field1': convert_pressure,'field2': temp3,'field3': humidity,'field4': cpu_pc,'field5':cpu_temp,'field6': mem_avail_mb,'key':'WIR86RDKQQ6A4HWA'})
    try:
